        ...
        <div className="container">
            ...
            <div className="footer__block-body">
              <ul className="footer__block-list">
                <li className="footer__block-list-item">
                  <Link to='/' className="footer__block-list-link"> men </Link>
                </li>
                <li className="footer__block-list-item">
                  <Link to='/' className="footer__block-list-link"> women </Link>
                </li>
                <li className="footer__block-list-item">
                  <Link to='/' className="footer__block-list-link"> all </Link>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="footer__block">
            ...
            <div className="footer__block-body">
              <ul className="footer__block-list">
                <li className="footer__block-list-item">
                  <Link to='/' className="footer__block-list-link"> payments </Link>
                </li>
                <li className="footer__block-list-item">
                  <Link to='/' className="footer__block-list-link"> shipping </Link>
                </li>
                <li className="footer__block-list-item">
                  <Link to='/' className="footer__block-list-link"> returns </Link>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="footer__block">
            ...
            <div className="footer__block-body">
              <ul className="footer__block-list">
                <li className="footer__block-list-item">
                  <Link to='/' className="footer__block-list-link"> contacts </Link>
                </li>
                <li className="footer__block-list-item">
                  <Link to='/' className="footer__block-list-link"> privacy policy </Link>
                </li>
                <li className="footer__block-list-item">
                  <Link to='/' className="footer__block-list-link"> right of withdrawal </Link>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="footer__block footer__block-social">
            <Link to='/' className="footer__block-social-item footer__block-instagram icon-48px icon-shadow">
            ...
            <Link to='/' className="footer__block-social-item footer__block-fb icon-48px icon-shadow">
              <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M5 5H39V39H5V5Z" fill="#4EFF9F" />
                <path fillRule="evenodd" clipRule="evenodd" d="M4 5C4 4.44772 4.44772 4 5 4H39C39.5523 4 40 4.44772 40 5V39C40 39.5523 39.5523 40 39 40H5C4.44772 40 4 39.5523 4 39V5ZM6 6V38H38V6H6Z" fill="black" />
            ...
            <Link to='/' className="footer__block-social-item footer__block-twitter icon-48px icon-shadow"
            ><svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M5 5H39V39H5V5Z" fill="#4EFF9F" />
                <path fillRule="evenodd" clipRule="evenodd" d="M4 5C4 4.44772 4.44772 4 5 4H39C39.5523 4 40 4.44772 40 5V39C40 39.5523 39.5523 40 39 40H5C4.44772 40 4 39.5523 4 39V5ZM6 6V38H38V6H6Z" fill="black" />
